...
describe('renderText headless visual', () => {
  ...
  test.skipIf(isLfsPointer(repoPath('tests/fixtures/fonts/NotoSansSC-Regular.ttf')))(
  ...
  test.skipIf(isLfsPointer(repoPath('tests/fixtures/fonts/NotoNaskhArabic-Regular.ttf')))(
