...
| `OPENPENCIL_MCP_DISCOVERY_PATH` | Platform default | Override discovery file (`mcp.json`) location (server/test only; the desktop app computes its own platform-default path) |
