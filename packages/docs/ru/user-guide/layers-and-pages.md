...
description: Управление слоями, страницами и панелью свойств в Inkly.
---
...
- **Inkly JSX** — дерево компонентов, совместимое с `renderJsx()` для программного двустороннего преобразования
