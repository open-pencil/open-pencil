...
description: Структура папок, границы публичного API и паттерны компоновки в @inkly/vue.
---

# Архитектура SDK

`@inkly/vue` — Vue-слой поверх `@inkly/core`.
...
Если кусок логики можно переиспользовать в другом приложении на базе Inkly без привнесения стилей — скорее всего, ему место в `@inkly/vue`.
