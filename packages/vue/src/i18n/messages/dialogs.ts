...
export const dialogMessageDefaults = {
  ...
  mcpConnectionsDescription: 'Give agent sessions access to trusted remote tools and services.',
  ...
  enableMCPConnection: 'Enable for agent sessions',
  ...
  directModelProviders: 'Direct model providers',
  harnessProviders: 'Harness providers',
  localACPAgents: 'Local ACP agents',
  directModelGuidance:
    'Best for everyday chat and design edits. OpenPencil calls the model API directly with your key.',
  harnessGuidance:
    'Best for longer autonomous work with a managed workspace and shell. Requires the optional Harness companion and a model key.',
  acpGuidance:
    'Best when you already use Claude Code, Codex, or Gemini CLI. Reuses the installed agent and its existing sign-in.',
  harnessProviderBadge: 'Harness',
  acpAgentBadge: 'ACP',
  ...
  harnessCompanion: 'Harness companion',
  harnessCompanionInstalled: params('Installed · {version}'),
  harnessCompanionIncompatible: params('Version {version} is incompatible.'),
  harnessCompanionMissing: params('Not installed · {command}'),
  harnessCompanionCheck: 'Check again',
  harnessCompanionChecking: 'Checking…',
