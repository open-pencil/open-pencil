...
Встроенный ассистент имеет доступ к более чем 90 инструментам, покрывающим все возможности редактора. Опишите, что вам нужно, на естественном языке — «добавь тень 16px ко всем кнопкам», «создай компонент карточки с вариантом для тёмной темы», «экспортируй каждый фрейм на этой странице в 2×».
...
[MCP-сервер →](/programmable/mcp-server)
