---
title: useI18n
description: Odczytuj zlokalizowane komunikaty UI Inkly i przełączaj aktywny język SDK.
---

# useI18n

`useI18n()` zwraca reaktywne grupy tłumaczeń oraz kontrolki języka dla powłok edytora opartych na Inkly.
