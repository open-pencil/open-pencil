const layoutAlignmentTheme = {
  slots: {
    ...
    cell: 'flex size-6 cursor-pointer items-center justify-center rounded border text-[11px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50',
