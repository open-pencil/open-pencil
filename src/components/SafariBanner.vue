...
const { safariBanner: safariBannerT } = useI18n()
...
<template>
  ...
  >
    <span class="flex-1">
      {{ safariBannerT.messagePrefix }}
      <a href="https://www.google.com/chrome/" target="_blank" class="font-medium underline">{{ safariBannerT.useChrome }}</a>
      {{ safariBannerT.messageSuffix }}
    </span>
    <button
