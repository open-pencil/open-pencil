...
export const dialogMessages = i18n('dialogs', {
  ...
  mcpServerURLPlaceholder: 'MCP server URL (e.g. http://127.0.0.1:7600/mcp)',
  mcpServerAuthTokenPlaceholder: 'Auth token (optional)',
  mcpServerHint: 'Used by ACP agents to reach the OpenPencil MCP endpoint.',
