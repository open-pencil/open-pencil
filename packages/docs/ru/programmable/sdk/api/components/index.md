---
title: Компоненты
description: Справочник компонентов — headless-примитивы Vue в @inkly/vue.
---

# Компоненты

`@inkly/vue` предоставляет headless-структурные примитивы для подключения холста, навигационного UI, панелей свойств и специализированных элементов ввода.
