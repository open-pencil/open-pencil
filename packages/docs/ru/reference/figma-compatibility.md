...
| Библиотеки (публикация, обмен, обновление) | ✅ | Неизменяемые локальные/удалённые ревизии, выборочная публикация, просмотр обновлений, офлайн-режим и сохранение в `.fig` |
