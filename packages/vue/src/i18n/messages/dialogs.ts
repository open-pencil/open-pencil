...
export const dialogMessageDefaults = {
  ...
  cloudConnectionSuccess: 'Connected. Namespace ready — web app can use this bucket.',
  cloudConnectionSuccessWithCors:
  ...
  cloudUsageHint:
    'Size of OpenPencil data in this bucket (open_pencil_storage/). Providers do not expose free space over S3, so this is usage — not “% full”.',
  cloudUsageOneCanvas: '1 canvas',
  cloudUsageCanvasesLabel: 'canvases',
  cloudUsageObjectsLabel: 'objects',
  deleteCanvas: 'Delete',
  renameCanvas: 'Rename',
  cloudLoadFailed: 'Could not load canvases from cloud storage.',
