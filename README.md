...
- **Local-first cloud workspace** — connect an S3-compatible bucket or an S3-enabled Bunny Storage Zone, with automatic background synchronization and no manual CORS setup for Bunny
