...
description: Configura @inkly/vue con createEditor, provideEditor y un canvas.
---
...
El SDK vive en el monorepo hoy en día y también se publica como `@inkly/vue`.
...
1. `@inkly/core` — motor del editor independiente del framework
2. `@inkly/vue` — composables de Vue y primitivos headless
