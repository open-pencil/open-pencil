...
I nodi vivono in una mappa piatta `Map<string, Node>` keyed by GUID string. La struttura ad albero è mantenuta via `parentIndex` references. This gives Lookup O(1) by ID and efficient traversal.
