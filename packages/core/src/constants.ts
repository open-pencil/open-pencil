...
export const CANVAS_BG_COLOR_DARK = {
	r: 0.173,
	g: 0.173,
	b: 0.173,
	a: 1,
} satisfies Color; // #2c2c2c, Figma-ish dark canvas
...
export const RULER_BG_COLOR = {
	r: 0.14,
	g: 0.14,
	b: 0.14,
	a: 1,
} satisfies Color;
export const RULER_TICK_COLOR = {
	r: 0.4,
	g: 0.4,
	b: 0.4,
	a: 1,
} satisfies Color;
export const RULER_TEXT_COLOR = {
	r: 0.55,
	g: 0.55,
	b: 0.55,
	a: 1,
