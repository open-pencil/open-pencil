...
```json
{
  ...
  "vue": "^3.5.29",
  "yoga-layout": "npm:@verso/yoga-layout@3.3.0-grid.2",
  "nanoevents": "^9.1.0",
  "sucrase": "^3.35.1",
  "reka-ui": "^2.8.2",
  "tailwindcss": "^4.2.1",
...
|-----------|---------|-------|
| CSS Grid w Yoga | Auto layout oparty na siatce | ✅ Obsługiwane przez [fork Yoga](https://github.com/open-pencil/yoga/tree/grid) (`@verso/yoga-layout`) |
