...
- Expose Figma-style mask, visibility, lock, flip, component, z-order, distribution, selection, move-to-page, ruler, multiplayer cursor, and Settings actions from the shared browser and desktop menus.
