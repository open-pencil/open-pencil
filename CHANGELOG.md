...
- Fix cold-cache hard refresh showing tofu for Chinese text by awaiting bundled CJK in `loadFonts()` and re-registering fonts when the CanvasKit provider is recreated.
