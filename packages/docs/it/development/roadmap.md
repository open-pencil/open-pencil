...
**Consegnato:**
- @verso/core estratto in packages/core/ (nessuna dipendenza DOM)
- @verso/cli con operazioni headless .fig (info, tree, find, export, analyze, eval)
...
- Server MCP (@verso/mcp): stdio + HTTP, 87 strumenti core + 3 gestione file
