...
```
packages/
  core/              @verso/core — silnik (zero zależności DOM)
    src/             Graf sceny, renderer, layout, kodek, kiwi, typy
  cli/               @verso/cli — headless CLI do operacji .fig
    src/commands/    info, tree, find, export, eval, analyze
  mcp/               @verso/mcp — serwer MCP dla narzędzi AI
...
src/
  ...
  engine/            Shimy re-eksportu z @verso/core
  kiwi/              Shimy re-eksportu z @verso/core
