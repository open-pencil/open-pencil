...
- Add a reference OpenPencil Cloud Compose deployment with PostgreSQL and SeaweedFS, including automatic migrations, readiness checks, persistent storage, full revision-flow integration coverage, and bounded multi-worker upload cleanup.
