...
export const dialogMessageDefaults = {
  cloudShareDocument: params('Share “{name}”'),
  cloudShareDocumentAria: 'Share document',
  cloudShareSettings: 'Share settings',
  cloudEmailAddress: 'Email address',
  cloudInvitationPermission: 'Invitation permission',
  cloudPersonPermission: 'Person permission',
  cloudLinkPermission: 'Link permission',
  cloudLinkExpiration: 'Link expiration',
  cloudInvite: 'Invite',
  cloudWhoHasAccess: 'Who has access',
  cloudWorkspaceMembers: 'Workspace members',
  cloudInheritedAccess: 'Inherited access',
  cloudCanView: 'Can view',
  cloudCanEdit: 'Can edit',
  cloudAccepted: 'Accepted',
  cloudInvitationPending: 'Invitation pending',
  cloudRemoveAccess: 'Remove access',
  cloudRevokeInvitation: 'Revoke invitation',
  cloudGeneralAccess: 'General access',
  cloudAnyoneWithLink: 'Anyone with the link',
  cloudRestricted: 'Restricted',
  cloudOnlyMembersAndInvited: 'Only workspace members and invited people',
  cloudOnlyInvited: 'Only invited people',
  cloudOneTimeLink: 'This link is shown once. Copy it now or regenerate it later.',
  cloudDisableLink: 'Disable link',
  cloudRegenerateLink: 'Regenerate link',
  cloudCreateAndCopyLink: 'Create and copy link',
  cloudWhatTheyCanDo: 'What they can do',
  cloudAdvanced: 'Advanced',
  cloudRelayDescription:
  ...
  cloudNever: 'Never',
  cloudOneDay: '1 day',
  cloudSevenDays: '7 days',
  cloudThirtyDays: '30 days',
  cloudStatusConnected: 'Connected',
  cloudStatusSignInRequired: 'Sign in required',
  cloudStatusSignInRequiredDescription: 'Sign in to access this instance and its workspaces.',
  cloudStatusReauthenticationRequired: 'Reauthentication required',
  cloudStatusReauthenticationRequiredDescription: 'Your saved session is no longer accepted.',
  cloudStatusConnecting: 'Connecting…',
  cloudStatusOffline: 'Offline',
  cloudStatusOfflineDescription: 'This instance cannot currently be reached.',
  cloudStatusConnectionError: 'Connection error',
  cloudStatusConnectionErrorDescription: 'OpenPencil could not connect to this instance.',
  cloudStatusDisconnected: 'Disconnected',
  cloudStatusDisconnectedDescription:
    'Synchronization is paused until this instance is reconnected.',
  cloudOpenWorkspace: 'Open workspace',
  cloudReauthenticate: 'Reauthenticate',
  cloudSignIn: 'Sign in',
  cloudReconnect: 'Reconnect',
  cloudRetryConnection: 'Retry connection',
  cancel: 'Cancel',
  apply: 'Apply',
  close: 'Close',
  rename: 'Rename',
