...
Knoten leben in einer flachen `Map<string, Node>` keyed by GUID string. Baumstruktur wird über `parentIndex` references. This gives O(1)-Lookup by ID and efficient traversal.
