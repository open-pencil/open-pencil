...
export const dialogMessageDefaults = {
  ...
  slidePosition: params('{current} / {total}'),
  presenterNotes: 'Presenter notes',
  addPresenterNotes: 'Add presenter notes…',
  showPresenterNotes: 'Show presenter notes',
  restartPresentation: 'Restart from the first slide',
  noNotesForSlide: 'No notes for this slide',
  backToEditing: 'Edit',
  presentSoloDescription: 'Just one view — no presented notes.',
  presentWithNotesDescription: 'One view for sharing, another for your notes.',
  copy: 'Copy',
  copied: 'Copied',
  ...
  storageWorkspace: 'OpenPencil workspace',
  cloudConnectedVia: params('Cloud connected via {provider}'),
  cloudNotConnected: 'Working offline — no cloud connected',
  ...
  syncStatusShowDetails: 'Show sync details',
  syncErrorTitle: 'Sync problem',
  syncErrorDescription: 'The last synchronization attempt did not complete.',
  syncErrorNoDetail: 'No failure details were recorded for this state.',
  syncErrorOperation: 'What failed',
  syncErrorDestination: 'Destination',
  syncErrorDocuments: 'Affected documents',
  syncErrorTime: 'Time',
  syncErrorAttempts: 'Attempts',
  syncErrorRaw: 'Provider error',
  ...
  syncOperationPutMetadata: 'Updating document details',
  syncOperationPutThumb: 'Uploading preview image',
  syncOperationDeleteCanvas: 'Deleting document',
  syncGuidanceCredentials:
    'The provider rejected the credentials. Re-enter the access key and secret in storage settings.',
  syncGuidancePermission:
    'The credentials were accepted but are not allowed to perform this operation. Grant the missing permission named below to the key.',
  syncGuidanceNotFound:
    'The bucket or object was not found. Check the bucket name and endpoint in storage settings.',
  syncGuidanceCors:
    'The browser blocked the request before it reached the bucket, which almost always means the bucket has no CORS rule for this origin. Paste the configuration below into the bucket CORS settings, wait about a minute, then retry.',
  syncGuidanceUnreachable:
    'The endpoint could not be reached. Check the endpoint URL and whether the service is available.',
  syncGuidanceOffline:
    'This device is offline. Your changes are saved on this device and will sync by themselves once the connection returns.',
  syncGuidanceServer:
  ...
  storageDeletePermanentlyTitle: 'Delete document permanently?',
  ...
  dropStorageFiles: 'Drop .fig or .deck files to upload',
  importingStorageFiles: 'Importing files…',
  storageSupportedFilesOnly: 'Only .fig and .deck files can be uploaded here.',
  copyStorageCors: 'Copy CORS JSON',
  copyStorageError: 'Copy error details for a bug report',
