import { hitTestCornerRotationByMatrix } from '#vue/shared/input/geometry'
...
export function tryStartRotation(editor: Editor, setDrag: SetDrag, cx: number, cy: number): boolean {
...
export function handleRotateMove(editor: Editor, d: DragRotate, sx: number, sy: number, shiftKey: boolean) {
