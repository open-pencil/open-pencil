import { getAbsoluteRotation, getWorldHandles } from '@inkly/core/canvas'
import { CORNER_ROTATE_ZONE, HANDLE_HIT_RADIUS } from '@inkly/core/constants'
import type { Editor } from '@inkly/core/editor'
import { degToRad } from '@inkly/core/geometry'
