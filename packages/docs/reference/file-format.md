---
title: File Format
description: Technical reference for Inkly .fig and .pen document formats, Kiwi binary structure, import pipeline, and export behavior.
---
...
Encoding happens synchronously in the copy event handler (not async Clipboard API) for browser compatibility. This enables bidirectional clipboard between Inkly and Figma.
