---
title: useI18n
description: Lokalisierte Inkly-UI-Nachrichten lesen und die aktive SDK-Locale wechseln.
---

# useI18n

`useI18n()` gibt reaktive Übersetzungsgruppen sowie Locale-Steuerelemente für Inkly-gestützte Editor-Shells zurück.
