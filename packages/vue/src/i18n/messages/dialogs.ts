...
export const dialogMessageDefaults = {
  ...
  queuedMessages: params('Queued ({count})'),
  resumeQueue: 'Resume',
  clearQueue: 'Clear queue',
  removeQueuedMessage: 'Remove queued message',
  removeChatMessage: 'Remove message',
  removeToolExecution: 'Remove tool execution',
  toolFinished: 'Done',
  toolRunning: 'Running…',
  toolError: 'Error',
  ...
  modelRoleAudioDescription: 'Voice input and transcription',
  ...
  mcpStatus: 'Status',
  mcpPort: 'Port',
  mcpAddress: 'MCP endpoint',
  mcpVersion: 'Version',
  mcpCopyEndpoint: 'Copy MCP endpoint',
  mcpCopyAccessToken: 'Copy access token',
  mcpAccessTokenUnavailable: 'The MCP access token is unavailable.',
  ...
  mcpAuthenticationDescription:
    'Protect the MCP endpoint with a bearer token. Disable only on a trusted network. Restart the server to apply changes.',
  mcpLanAccess: 'Allow LAN access',
  mcpLanAccessDescription:
    'Expose MCP on your local network at 0.0.0.0. Anyone on the network can access it when authentication is disabled. Restart the server to apply changes.',
  ...
  toolInput: 'Input',
  toolOutput: 'Output',
  toolImageSentToAI: 'Image sent to AI',
  ...
  contextUsage: params(
    'Context window:\n{percent}% used ({leftPercent}% left)\n{used} / {total} tokens used'
  ),
  contextUsageUnknown: params(
    '{used} tokens used\nSet the context window in model settings to see what is left.'
  ),
  optional: 'Optional',
  clear: 'Clear',
