---
title: useI18n
description: Leggi i messaggi UI Inkly localizzati e cambia la lingua attiva dell'SDK.
---

# useI18n

`useI18n()` restituisce gruppi di traduzione reattivi e controlli della lingua per le shell editor basate su Inkly.
