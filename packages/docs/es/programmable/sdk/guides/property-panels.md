...
Los paneles de propiedades en `@inkly/vue` están diseñados de forma intencionalmente composable primero.
...
```vue
<script setup lang="ts">
import { PropertyListRoot, useFillControls } from '@inkly/vue'
