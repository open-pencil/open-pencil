...
Węzły żyją w płaskiej mapie `Map<string, Node>` keyed by GUID string. Struktura drzewa utrzymywana przez `parentIndex` references. This gives Wyszukiwanie O(1) by ID and efficient traversal.
