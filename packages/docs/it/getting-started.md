...
| `bun run docs:build` | Build locale rapido della documentazione |
| `bun run docs:build:production` | Build completo e distribuibile della documentazione |

## App desktop (Tauri)

L'app desktop richiede Rust e prerequisiti specifici per la piattaforma. Consultare la [versione inglese](/getting-started) per le istruzioni dettagliate per macOS, Windows e Linux.
