...
```json
{
  ...
  "vue": "^3.5.29",
  "yoga-layout": "npm:@inkly/yoga-layout@3.3.0-grid.2",
  "nanoevents": "^9.1.0",
  "sucrase": "^3.35.1",
  "reka-ui": "^2.8.2",
  "tailwindcss": "^4.2.1",
...
|-----------|---------|-------|
| CSS Grid in Yoga | Auto layout basato su griglia | ✅ Incluso tramite [fork Yoga](https://github.com/inkly/yoga/tree/grid) (`@inkly/yoga-layout`) |
