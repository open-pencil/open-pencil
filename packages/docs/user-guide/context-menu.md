---
title: Context Menu
description: Right-click context menu actions in Inkly — clipboard, z-order, grouping, components, and more.
---
...
- **Copy as JSX** — copies the Inkly JSX representation for use with `renderJsx()`
