/**
 * Tests for basic geometry utility functions in packages/core/src/geometry.ts.
 *
 * These pure functions handle angle conversion, point rotation, and rotated
 * bounding box calculations.
 */
import { describe, test, expect } from 'bun:test'

import { degToRad, radToDeg, rotatePoint, rotatedCorners, rotatedBBox } from '@open-pencil/core'
